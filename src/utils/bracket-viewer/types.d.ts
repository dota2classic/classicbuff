import { Stage, Match, MatchGame } from "brackets-model";
import { BracketsViewer } from "./main";
import { TournamentBracketMatchDto, TournamentBracketParticipantDto } from "../../api/back/models";
...
export interface ViewerData {
  ...
  participants: TournamentBracketParticipantDto[];
}
